...
export const HeroSection = () => {
  return (
    <section id="top" className="bg-gradient-to-br from-primary-purple to-secondary-purple text-white py-20 md:py-28 lg:py-32">
      <div className="container text-center">
        ...
        <p className="text-lg md:text-xl text-purple-200 max-w-3xl mx-auto mb-8">
          스마트 컨트랙트 기반 에스크로 Trustless Trade로 중고거래 사기 위험을 없애고, 판매자와 구매자 모두를 보호하세요.
        </p>
